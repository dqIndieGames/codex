...
pub(crate) struct Session {
    ...
    pub(super) pending_provider_runtime_refresh: Mutex<Option<PendingProviderRuntimeRefresh>>,
    ...
    pub(crate) async fn new(
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let services = SessionServices {
                ...
                .with_force_service_tier_priority(config.force_service_tier_priority)
