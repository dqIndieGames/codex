...
struct PreparedRealtimeConversationStart {
    ...
    realtime_call_base_url: Option<String>,
}
...
async fn prepare_realtime_start(
    ...
    let realtime_call_base_url = config.experimental_realtime_webrtc_call_base_url.clone();
...
async fn handle_start_inner(
    ...
    let start_output = loop {
        ...
        let start = RealtimeStart {
            ...
            client_managed_handoffs,
            codex_responses_as_items,
            codex_response_item_prefix: codex_response_item_prefix.clone(),
            codex_response_handoff_prefix: codex_response_handoff_prefix.clone(),
            realtime_call_api_provider,
